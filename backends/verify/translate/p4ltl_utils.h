...
const cstring P4LTL_KEYS_CPI_SIMP = "//#CPI_SIMP:";
const cstring P4LTL_KEYS_REG_WRITE = "//#register_write";
const std::vector<cstring> P4LTL_KEYS = {P4LTL_KEYS_VAR, P4LTL_KEYS_SPEC, P4LTL_KEYS_FAIR, 
										P4LTL_KEYS_CPI, P4LTL_KEYS_CPI_MODEL, P4LTL_KEYS_CPI_SPEC, P4LTL_KEYS_CPI_SIMP, P4LTL_KEYS_REG_WRITE};
...
public:
	...
	std::set<cstring> getCPITable(P4LTL::AstNode* root);
	cstring translateCPI(P4LTL::AstNode* node);
	std::pair<cstring, cstring> extractCPI(P4LTL::AstNode* node);
	...
	int getSpecSize(P4LTL::AstNode* root); 
};
#endif